...
public class CNode : EbFsm, IDisposable
{
    ...
    INodeServerListener mNodeServerListener = null;
    INodeClientListener mNodeClientListener = null;
    INodeServerScript mNodeServerScript = null;
    INodeClientScript mNodeClientScript = null;
    CNodeSys mNodeSys = null;
    CNodeMgr mNodeMgr = null;
    CNode mParentNode = null;
    ...
    public int getExitId()
    {
        ...
        {
            exit_id = (int)mMapParam[(byte)_eNodeParam.ExitId];
        }
    ...
    {
        _eNodeState next_state = node_op.state;
        if (next_state == _eNodeState.Run)
        {
            postEvent("evSetRunState", node_op.list_param);
        }
        else if (next_state == _eNodeState.Stop)
        {
            postEvent("evSetStopState", node_op.list_param);
        }
    }
    ...
    //-------------------------------------------------------------------------
    public List<INodeTrigger> _getTriggerList()
    {
        return mTriggerList;
    }
