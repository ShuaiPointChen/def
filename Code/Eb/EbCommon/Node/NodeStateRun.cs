...
class CNodeStateRun : EbState
{
    ...
    public CNodeStateRun(CNode node)
    {
        ...
        _defState("CNodeStateRun", "Fsm", 0, false);
    ...
    {
        EbLog.Note("CNodeStateRun.enter() NodeType=" + mNode.getNodeType() + " NodeId=" + mNode.getNodeId());
    ...
    {
        EbLog.Note("CNodeStateRun.exit() NodeType=" + mNode.getNodeType() + " NodeId=" + mNode.getNodeId());
    }
