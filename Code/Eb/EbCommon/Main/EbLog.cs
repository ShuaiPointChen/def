...
public static class EbLog
{
    ...
    public delegate void OnDrawLineDelegate(Eb.EbVector3 start, Eb.EbVector3 end, EbColor color);
    ...
    //-------------------------------------------------------------------------
    public static void DrawLine(Eb.EbVector3 start, Eb.EbVector3 end, EbColor color)
    {
        OnDrawLine(start, end, color);
    }

    //-------------------------------------------------------------------------
    public static void DrawRay(Eb.EbVector3 origin, Eb.EbVector3 direct, EbColor color)
    {
